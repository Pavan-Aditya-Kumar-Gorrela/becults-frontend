            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                <motion.button
                  ...
                  className="flex items-center justify-center gap-2 bg-slate-700/50 border border-slate-600 hover:border-slate-500 rounded-lg py-2 transition text-sm"
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24">
                    <path fill="white" d="M12.545,10.239v3.821h5.445c-0.712,2.315-2.647,3.972-5.445,3.972c-3.332,0-6.033-2.701-6.033-6.032 c0-3.331,2.701-6.032,6.033-6.032c1.498,0,2.866,0.549,3.921,1.453l2.814-2.814C17.461,2.268,15.365,1,12.545,1 C6.777,1,2,5.777,2,11.545c0,5.769,4.777,10.545,10.545,10.545c6.032,0,10.545-4.513,10.545-10.545 C23.091,11.52,23.027,10.838,23.007,10.239H12.545z"/>
                  </svg>
                  Google
                </motion.button>
                <motion.button
