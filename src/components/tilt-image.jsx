...
export default function TiltedImage({ rotateAmplitude = 3 }) {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://framerusercontent.com/images/2ZvgC9aVEIH03Udm4HIzE3In0.png?scale-down-to=512&width=617&height=585"
          className="w-full rounded-[15px] will-change-transform [transform:translateZ(0)] w-20 h-100"
