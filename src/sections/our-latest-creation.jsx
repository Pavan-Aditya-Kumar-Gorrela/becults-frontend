  ...
  const sectionData = [
    {
      title: 'C Workshop',
      description:
        'Mastering C language that empowers logical building.',
      image:
    ...
    },
    {
      title: 'Video Editing',
      description:
        'Turning world into actionable frames that drive intelligent innovation and growth.',
      image:
    ...
    },
    {
      ...
      description:
        'Building scalable and efficient web solutions that bring ideas to life through code.',
      image:
